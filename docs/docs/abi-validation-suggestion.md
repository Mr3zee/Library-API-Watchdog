...
reviews the shape of new API declarations, but it doesn't notice when the API that is already shipped
...
- [Binary Compatibility Validator (legacy)](https://github.com/Kotlin/binary-compatibility-validator)
